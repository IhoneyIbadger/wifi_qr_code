...
<template>
  <footer class="max-w-screen-xl w-full mx-auto mt-auto px-4 flex justify-between items-center h-16 text-gray-500">
    ...
    <nav class="flex font-medium text-sm gap-x-6">
      <RouterLink to="/imprint" class="hover:text-black">Imprint</RouterLink>
      
      <RouterLink to="/privacy" class="hover:text-black">Privacy</RouterLink>
    </nav>
  </footer>
</template>